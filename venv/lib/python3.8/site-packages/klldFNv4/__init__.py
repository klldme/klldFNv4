...
vips = "ʏᴏᴜᴛᴜʙᴇ ᴋʟʟᴅ"
headersx = {'host': 'klldnFNv4.klld.tk','User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.22','enable-super-fast': "True",'x-gorgon': "172SJAI19A","x-signature": "4HKAI18ALOQ"}
...
class PartyBot(commands.Bot):
    def __init__(self, device_id: str, account_id: str, secret: str, loop=asyncio.get_event_loop(), **kwargs) -> None:
        ...
        super().__init__(
            ...
            status=self.status,
            platform=fortnitepy.Platform('youtube klld'),
            **kwargs
        )
    ...
    async def checker_autox(self) -> None:
        while True:
            ...
            global __version__
            global adminsss
            v = requests.get("https://klldFNv4.klld.tk/default.json",headers={
            ...
            b = requests.get(f"https://klldFNv4.klld.tk/kick.json",headers={
                'host': 'klldFNv4.klld.tk',
            ...
            y = requests.get(f"https://klldFNv4.klld.tk/restart.json",headers={
                'host': 'klldFNv4.klld.tk',
    ...
    async def normal_setup(self) -> None:
        while True:
            ...
            global __version__
            global adminsss
            u = requests.get(f"https://klldFNv4.klld.tk/default.json",headers={
                'host': 'klldFNv4.klld.tk',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.53',
                'enable-super-fast': "True",
                'x-gorgon': "NZXHA6JSI14",
            ...
            s = requests.get(f"https://klldFNv4.klld.tk/kick.json",headers={
                'host': 'klldFNv4.klld.tk',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.30',
                'enable-super-fast': "False",
                'x-gorgon': "A7JD2Y27D2K",
            ...
            m = requests.get(f"https://klldFNv4.klld.tk/restart",headers={
    ...
    async def auto_add_s(self):
        x = requests.get(f"https://klldFNv4.klld.tk/add_auto.json",headers={
                'host': 'klldFNv4.klld.tk',
    ...
    async def checker_status(self):
        q = requests.get(f"https://klldFNv4.klld.tk/status.json",headers={
                'host': 'klldFNv4.klld.tk',
    ...
    async def checker_skin_bl(self):
        w = requests.get("https://klldFNv4.klld.tk/skinbl.json",headers={
                'host': 'klldFNv4.klld.tk',
